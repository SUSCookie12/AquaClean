...
import { LogIn, LogOut, Settings as SettingsIcon, UserCircle, LayoutDashboard, Home, ShoppingBag as ProductsIcon, ShoppingCart } from 'lucide-react';
...
const AppHeader = () => {
  ...
  // Conditionally add admin link to main nav if screen is large enough and user is admin
  // This avoids cluttering the main nav on mobile if dropdown already has it.
